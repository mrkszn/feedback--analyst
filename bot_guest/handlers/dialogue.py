...
from bot_guest.handlers.feedback import _finalize_session
from config import settings
from integrations.whisper import transcribe_voice
from services.sessions import append_session_message
    ...
    *,
    ...
    if pool:
        ...
        await message.answer(
            "Спасибо за разговор! 🙏 У ресторана есть пара коротких вопросов "
            "специально под твой отзыв — займут минутку. За ответы я подарю "
            "скидку 🎁 на следующий визит. Хочешь попробовать?",
