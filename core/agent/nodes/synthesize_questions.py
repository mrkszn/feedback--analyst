...
SYNTHESIZE_SYSTEM = (
    "Ты — помощник ресторана. Админ надиктовал, какие вопросы хочет задавать гостям. "
    "Преобразуй расшифровку в структурированные черновики вопросов.\n\n"
    "Контекст ресторана:\n{restaurant_context}\n\n"
...
REGENERATE_SYSTEM = (
    "Ты — помощник ресторана. Админ хочет заменить один из черновиков на другой "
    "вопрос той же тематики, но отличающийся от уже существующих.\n\n"
    "Контекст ресторана:\n{restaurant_context}\n\n"
